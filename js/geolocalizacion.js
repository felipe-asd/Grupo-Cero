$(document).ready(function () {
  function showPosition(position) {
    ...
    $.get(`https://www.metaweather.com/api/location/search/?lattlong=${lat},${lon}`,function (data){
      console.log('https://www.metaweather.com/api/location/search/?lattlong=' + lat + ',' + lon);

      $.get(`https://www.metaweather.com/api/location/${data[0].woeid}`,function (weather) {
        console.log("https://www.metaweather.com/api/location/" + data[0].woeid); 
